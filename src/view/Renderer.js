...
export class AnimationTimer {
    ...
    // private
    _initOptions(defaultOptions, givenOptions) {
    ...
    _loop() {
        if (typeof this.point != "undefined") {
            ...
            if ((this.i > 0 ? this.point.x < this.defaultOptions.end : (this.i < 0 ? this.point.x > this.defaultOptions.end : false)) && !this.stopped)
                this._doLoop();
            else
